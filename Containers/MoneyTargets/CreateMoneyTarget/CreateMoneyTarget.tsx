...
export const CreateMoneyTarget = () => {
  ...
  return <View>
    <Form>
      ...
      <Item floatingLabel error={amountError?.length !== 0}>
        <Input placeholder="Amount" keyboardType='number-pad' onChangeText={setAmount} value={amount} disabled={submitting}/>
